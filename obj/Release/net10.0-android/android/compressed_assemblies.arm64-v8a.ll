...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [135 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2029056, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 14200200; uint32_t buffer_offset
	}, ; 132: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14371720; uint32_t buffer_offset
	}, ; 133: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2207744, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 14394280; uint32_t buffer_offset
	} ; 134: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 16602024, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [16602024 x i8] zeroinitializer, align 1
